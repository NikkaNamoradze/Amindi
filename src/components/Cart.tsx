...
import { useApi, useAppDispatch } from "../hooks/hooks";
...
const Cart: React.FC<ICart> = ({ name, index }) => {
  const { data: weather, saveData } = useApi<WeatherResponse>({
    url: `https://api.openweathermap.org/data/2.5/weather?q=${name}&units=metric&appid=20c4bd51cf84f12ebda1a2d7f69862bc`,
  });
