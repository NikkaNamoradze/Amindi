...
export const Header: React.FC<IHeader> = ({ theme, setTheme }) => {
  ...
  return (
    <header className={theme ? 'dark sticky top-0' : 'sticky top-0'}>
      <div className='dark:bg-[#1F2937] bg-[#fefefe] drop-shadow-md rounded-b-lg p-0.5'>
        <nav className=' flex items-center justify-between mx-auto px-3 lg:px-6 py-2.5'>
      ...
      transition-all focus:outline-none focus:ring-2 focus:ring-gray-400'
        ...
        {burger && (
          <div className='dark:text-gray-100 text-gray-700 mx-auto block lg:hidden font-semibold fixed w-full'>
